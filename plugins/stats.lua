...
local function run(msg, matches)
  if matches[1]:lower() == 'deadkings' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "deadkings" then -- Put everything you like :)
...
return {
	usage = {
		...
		"stats deadkings: Return Users And Groups Stats.",
		"deadkings: Return About Text.",
		},
  patterns = {
    "^([Ss]tats)$",
    "^([Ss]tatslist)$",
    "^([Ss]tats) (group) (%d+)",
    "^([Ss]tats) (deadkings)",-- Put everything you like :)
		"^([Dd]eadkings)"-- Put everything you like :)
    }, 
  run = run
}
